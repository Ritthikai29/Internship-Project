                    ...
                    <div class="tab-pane active" id="login">
                        <form class="form-horizontal login-form">
                            <div class="form-group relative   ">
                                <label class="form-label" for="form1Example13">กรุณาใส่รหัสผ่านใหม่</label>
                                <input type="password" autocomplete="username" id="form1Example13" name="email" class="form-control form-control-lg  shadow  rounded-3" />
                            </div>
                            <div class="form-group relative   ">
                                <label class="form-label" for="form1Example13">ยืนยันรหัสผ่าน</label>
                                <input type="password" autocomplete="username" id="form1Example13" name="email" class="form-control form-control-lg  shadow  rounded-3" />
                            </div>

                            <div class=" text-center   " style="margin-top: 50px;">
                                <button type="submit" class="btn btn-danger text-white btn-lg btn-block mt-1 w-100  shadow  rounded-3 ">ยืนยันเปลี่ยนรหัสผ่าน</button>
                            </div>
                        </form>
                    </div>
                </div>
