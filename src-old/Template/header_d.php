        ...
        <nav class="navbar navbar-expand-sm  navbar-dark   shadow-lg  p-3 mb-5 bg-body-tertiary rounded    " style="background-color: #EEEEEE;">
            ...
            <div class="col-7 collapse navbar-collapse justify-content-end pe-3" id="collapsibleNavbar">
                ...
                <ul class="navbar-nav   fw-bol db  float-end  fs-6  m-1-1-3-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link m-3" style="color: #000000; " href="">ประวัติโครงการ</a>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle m-3" href="#" id="navbardrop" data-toggle="dropdown" style="color: #000000; ">
                            โครงการที่รอจัดการ
                        </a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="p1.php">แจ้งเปิดซอง</a>
                            <a class="dropdown-item" href="p2.php">เปิดซอง</a>
                            <a class="dropdown-item" href="">เจรจา </a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link m-3  " style="color: #000000; " href="">ออกจากระบบ</a>
                    </li>
                ...
                <div class="ms-3">
                    <span class="material-symbols-outlined user-pic ms-1" onclick="toggleMenu()">account_circle</span>
                    <p class="text-dark">เลขา</p>
                </div>
