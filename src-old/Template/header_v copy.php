    ...
    <div class="container-fluid  sticky-top ">
        ...
        <nav class="navbar navbar-expand-sm  navbar-dark   shadow-lg  p-3 mb-5 bg-body-tertiary rounded    " style="background-color: #EEEEEE;">
            ...
            <div class="col-5 ">
                ...
                <a href="index.html"><img src="images/po2.png" class="figure-img img-fluid rounded float-start mt-0 ms-2   " style="height: 20% ; width:20%;  " alt="..."></a>
            ...
            <div class="col-7 collapse navbar-collapse justify-content-end pe-3" id="collapsibleNavbar">
                ...
                <ul class="navbar-nav   fw-bol db  float-end  fs-6  m-1-1-3-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link m-3 " style="color: #000000;  " href="">โครงการที่กำลังเข้าร่วม</a>
                    </li>
                ...
                <div class="ms-3">
                    <span class="material-symbols-outlined user-pic ms-2" onclick="toggleMenu()">account_circle</span>
