...
import CookieSettings from "./Cookie-setting";
...
const CookieConsent = () => {
  ...
  return (
    <div>
      <section className="fixed max-w-2xl p-4 mx-auto bg-white border border-gray-200 md:gap-x-4 right-12 bottom-16 dark:bg-gray-900 md:flex md:items-center dark:border-gray-700 rounded-2xl">
      ...
      {showCookieSettings && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
          <div className="z-10">
            <CookieSettings onClose={closeCookieSettings} />
          </div>
        </div>
      )}
    </div>
