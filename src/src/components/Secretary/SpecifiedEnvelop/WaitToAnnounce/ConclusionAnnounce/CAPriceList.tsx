            ...
            <React.Fragment key={index}>
              ...
              >
                ...
                >
                  ...
                  : item.newPrice === null ? 'ไม่มีการเสนอราคา':item.newPrice === 0 ? 'สละสิทธิ์': project.order === '1'?'ไม่มีการเจรจา':'ไม่ถูกเชิญเจรจา' }
                { (Number(item.order) > 0 )  &&( <button onClick={() => withOpenHistory(index)} className="inline-block m-[0.7em] text-[12px] border w-16 rounded-md border-cyan-950 text-cyan-950 hover:text-cyan-50 hover:bg-cyan-950 hover:translate-x-1"> ดูประวัติ</button> )}
                </p>
