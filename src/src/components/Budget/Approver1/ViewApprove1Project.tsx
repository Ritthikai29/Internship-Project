...
export default function ViewApprove1Project() {
            ...
            <div className="flex flex-col justify-center">
                <div className="flex flex-col border px-12 py-12 rounded-2xl bg-white drop-shadow-lg">
                  ...
                  <div className="mt-3 grid grid-cols-11">
                    ...
                    {/* <div className="grid grid-cols-1 md:grid-cols-2 mb-6 ml-6">
                        <div className="mt-3 text-2xl">เลขที่เอกสาร : {project?.key}</div>
                        <div className="ml-2 mt-3 text-2xl">สถานะ : {project?.status_name}</div>
                        <div className="mt-4 text-2xl">วันที่เพิ่ม: {dateTimeFormatter(project?.add_datetime || "")}</div>
                    </div> */}
