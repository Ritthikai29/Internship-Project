...
import OSInformationWorkTypes from "../../components/Secretary/OpeningSchedule/OSInfomationWorkTypes";
import OSProjectSettingInformation from "../../components/Secretary/OpeningSchedule/OSProjectSettingInformation";
import OSAdditionalDetailsAndFiles from "../../components/Secretary/OpeningSchedule/OSAdditionalDetailsAndFiles";
import OSStatusApplicationToBidding from "../../components/Secretary/OpeningSchedule/OSStatusApplicationToBidding";

export default function SelectListOpeningSchedule() {
    return (
        <div className="bg-[#F5F5F5]">
            ...
            {/* next  */}
            {
                <OSInformationWorkTypes />
            }
            {
                <OSProjectSettingInformation />
            }
            {
                <OSAdditionalDetailsAndFiles />
            }
            {
                <OSStatusApplicationToBidding />
            }
