...
import CommitteeInformationWorkTypes from "../../components/Committee/CommitteeManagementHistory/ListSelect/CommitteeInformationWorkTypes";
import CommitteeProjectSettingInformation from "../../components/Committee/CommitteeManagementHistory/ListSelect/CommitteeProjectSettingInformation";
import CommitteeAdditionalDetailsAndFiles from "../../components/Committee/CommitteeManagementHistory/ListSelect/CommitteeAdditionalDetailsAndFiles";
import CommitteeStatusApplicationToBidding from "../../components/Committee/CommitteeManagementHistory/ListSelect/CommitteeStatusApplicationToBidding";
import CommitteeNotificationBiddingResults from "../../components/Committee/CommitteeManagementHistory/ListSelect/CommitteeNotificationBiddingResults";

export default function CommitteeListSelect() {
    ...
    return (
        <div className="bg-[#F5F5F5]">
            ...
            {/* next  */}
            {
                <CommitteeInformationWorkTypes />
            }
            {
                <CommitteeProjectSettingInformation />
            }
            {
                <CommitteeAdditionalDetailsAndFiles />
            }
            {
                <CommitteeStatusApplicationToBidding />
            }
            {
                <CommitteeNotificationBiddingResults />
            }
            ...
            <div className="flex justify-start items-center my-14 mx-20">
                <button className="px-8 py-2.5 w-[180px] rounded-lg bg-[#EB455F] drop-shadow-lg text-white text-2xl col-start-1 text-center inline-flex items-center"
                    onClick={() => navigate("/committee/management-history")}>
