...
function htmlMaill(array $openDateTimePlace,array $listOpenBidding,$openBidding){
    $body = '
    <!DOCTYPE html>
<html lang="en">
<head>
    ...
    <table class="first-table">
        <tr>
            <td class="first-td">
                ...
                <p> สะดวกเข้าร่วมเปิดซองประกวดราคา ในวันที่  '. $openDateTimePlace['opendate'] . ' ' . $openDateTimePlace['opentime'] . ' 
                    จำนวน ' . $openBidding['total'] . '  โครงการ โดยมีรายละเอียดนี้ </p> 
                <br>  
        ...
        <tr>
            <td class="rd-td">
                ...
                <p class="custom-paragraph">วัน / เวลา</p>    
                    ...
                    <p class="custom-container custom-paragraph">&nbsp;'. $openDateTimePlace['opendate'] . ' ' . $openDateTimePlace['opentime'] . ' น.</p>
                ...
                &nbsp; คุณ '. $listOpenBidding[0]['firstname_t'].' &nbsp;   '. $listOpenBidding[0]['lastname_t'].' / '. $listOpenBidding[0]['mobile'].' / '. $listOpenBidding[0]['email'].'
                </p>
                </p>
            </td>
        </tr>
...
function GenerateTable($listOpenBidding)
{
    ...
    foreach ($listOpenBidding as $biddingData) {
        ...
        <td><p>' . $biddingData['department_name'] . ' / ' . $biddingData['division_name'] . '</p>
        <p>' . $biddingData['SECTION'] . ' / ' . $biddingData['SUBSECTION'] . '</p></td>
    </tr>';
    }
    return $table;
}