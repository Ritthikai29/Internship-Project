...
$search = $template->valVariable(isset($_GET["search"]) ? $_GET["search"] : null, "search input" );

$SearchlistVendor = $registerProjectService->getListVendorByCompanyOrStatus((int)$project['id'],$search);

$http->Ok([
    "data" => $SearchlistVendor,
    "status" => 200
]);