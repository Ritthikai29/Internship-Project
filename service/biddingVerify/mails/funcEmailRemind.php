    ...
    <table class="first-table">
        <tr>
            <td class="first-td">
                <br>
                <h1>
                    เรียน ' . $director['e_name'] . '
                </h1>
                <h1>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ขอแจ้งเตือนการเปลี่ยนรหัสเข้าร่วมเปิดซอง  วันที่ '. date('d/m/Y H:i', strtotime($openBidding['open_datetime'])) .'
                        โดยมีรายละเอียด Passcord ดังรายละเอียดข้างล่าง
                        <br>
                </h1>
    ...
    <table class="first-table"  style="padding: 20px; text-align: center; background: #4B81A8; border-radius: 10px; border: 1px rgba(0, 0, 0, 0.20) solid;">
            ...
            <td >
                <p style="color: white; font-size: 20px; font-weight: 600;">รายละเอียด Passcode ของท่านสำหรับเปิดซอง<br>
                    ...
                    <p style="font-size: 30px; font-weight: 800; background: #D9D9D9; margin-left: 40px; margin-right: 40px; padding-top: 15px; padding-bottom: 15px;" id="passcodeElement">
                    ' . $passcode . '
                </p>
            </td>
