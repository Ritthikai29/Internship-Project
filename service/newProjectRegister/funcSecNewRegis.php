...
<head>
    ...
    <title>Email-แจ้งหน่วยงานจ้างเหมามีการเสนอราคาใหม่จาก vendor</title>
    <style>
    ...
    <table class="first-table">
        <tr>
            <td class="first-td">
                <br>
                <h1>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ขณะนี้มีการ <span style="font-weight: 500; color: #0083FF; ">เสนอราคาใหม่</span> 
                ...
                <h1 class="nd-h1">
                    (เมื่อเข้าสู่ระบบ ให้ท่านเข้าไป " โครงการกำลังเข้าร่วม" และเลือก "ชื่อโครงการ" เพื่อตรวจสอบ) 
                </h1>
            </td>
        </tr>
    </table>
