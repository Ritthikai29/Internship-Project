...
$projectId = $template->valNumberVariable(isset($_GET["pid"]) ? $_GET["pid"] : null);

$listCommitteeComment = $biddingResultService->getMdApprovalByPID($projectId);

$http->Ok(
    [
        "data" => $listCommitteeComment,
        "status" => 200
    ]
);