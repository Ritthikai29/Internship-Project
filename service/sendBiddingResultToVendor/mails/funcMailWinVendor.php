...
function htmlMailWin($coordinator, $vendors, $project, $user)
{
    $body = '
    <!DOCTYPE html>
<html lang="en">
            ...
            <td class="first-td">
                ...
                <p style="margin-left: 20px;">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;บริษัท ปูนซิเมนต์ไทย(ทุ่งสง) จำกัด โดยหน่วยงาน<span>จ้างเหมา</span> 
                     ได้ประกวดราคา โครงการ :<span>     
                        "'.$project["name"].'"</span> เลขที่เอกสาร <span >'.$project['key'].'</span>
                        บัดนี้ได้ดำเนินการเสร็จเรียบร้อยแล้ว บริษัท' .$vendors['company_name']. ' ของท่าน ได้รับการพิจารณา 
                ...
                <p style="margin-left: 40px;">
                    2. ผู้ประสานงานโครงการ <span style="color: #0083FF;">
                        ' .$coordinator['coordinator_name']. '</p>
                <p style="margin-left: 20px;">
                    <br>
