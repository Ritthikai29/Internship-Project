<?php
// ใช้สำหรับการดึงข้อมูลสรุปผลของทางเลขานุการจาก project id
session_start();
...
$secretarySum = $bargainService->getFinalCommentByProjectId($project['id']);
if(!$secretarySum){
    $http->NotFound(
        [
            "err" => "ไม่พบข้อมูลการสรุปของเลาขา",
            "status" => 404
        ]
    );
}
