...
include_once("./SettingMailSend.php");

// $mail = new PHPMailer();

$mailTemplate = new Mailing();


$mailTemplate->sendTo("tanachod.sak@gmail.com");
$mailTemplate->addSubject("TEST");
$mailTemplate->addBody('
<!DOCTYPE html>
<html>
  <head>
