<?php
function htmlMailProjectCreate2($project, $contractor)
{
    return ('
    <!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title> โปรดตรวจสอบ โครงการ ' . $project["name"] . ' เลขที่  ' . $project['key']  . '</title>
    <style>
...
<body>
    ...
    <table class="first-table">
        ...
        <tr>
            <td class="first-td">
                <h1> เรียน <span> ' . $contractor["nametitle_t"] . " " . $contractor["firstname_t"] . " " . $contractor["lastname_t"] . ' </span> </h1>
                <h1>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; โปรดเข้าตรวจสอบเอกสาร 
