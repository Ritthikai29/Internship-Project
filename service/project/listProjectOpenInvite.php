...
$listProjects = $projectService->listProjectsByStatusName($offset, $limit, "กำลังประกวดราคา");

$totalProject = $projectService->getCountProjectByStatusName("กำลังประกวดราคา");
