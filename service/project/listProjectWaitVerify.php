...
$listProjects = $projectService->listProjectsByStatusName($offset, $limit, "รอตรวจสอบเอกสาร");

$totalProject = $projectService->getCountProjectByStatusName("รอตรวจสอบเอกสาร");
