<?php
function htmlMailApproveVendor(
    $project,
    ...
    foreach ($listVendorWaitApprove as $index => $value) {
        ...
        <p style="font-weight: 700;"> ที่ตั้งสำนักงาน :  ' . $value["location_detail"] . " " . $value["location_main"]["tambons_name_th"] . " " . $value["location_main"]["amphures_name_th"] . " " . $value["location_main"]["provinces_name_th"] . " " . $value["location_main"]["zip_code"] .' </p>
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0">
                            <tr>
                                <td class="second-td"  style="background-color: #1aa125;">
                                    <a class="login-a" href="http://137.116.132.150/STSBidding/frontend/contractor/verify-unlist-vendor/approve?approve_id=' . $approveVnedorProject["id"] . '" >
                                        &nbsp;&nbsp;อนุมัติ&nbsp;&nbsp;</a>
                                ...
                                <td class="second-td" style="background-color: #e90d0d; " >
                                     <a class="login-a" href="http://137.116.132.150/STSBidding/frontend/contractor/verify-unlist-vendor/reject?approve_id=' . $approveVnedorProject["id"] . '">
                                        &nbsp;&nbsp;ปฏิเสธ&nbsp;&nbsp;</a>
                                </td>
                            </tr>
                        </table>            
