...
if($approveVendorProject["approver2_id"] !== $userId){
    ...
    $http->Unauthorize(
        [
            "err" => "คุณไม่ใช่ผู้อนุมัติโครงการนี้",
...
$data = [
    ...
    "reject2_id" => $rejectVendorProject["id"], // reject from created
    ...
    "approve2"  => 0, // un approve this project => end process 
...
// send mail ไปหา ผู้เพิ่ม vendor นี้ ว่า "reject" นะ
