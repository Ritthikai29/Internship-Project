<?php
function htmlMailVerifierReject(
    $project, 
...
<head>
    ...
    <title>แจ้งแก้ไข/ ปฏิเสธ การตรวจสอบการคำนวณราคากลาง ชื่อโครงการ ' . $project["name"] . ' เลขที่  ' . $project['key']  . '</title>
    <style>
        .first-table {
            width: 1000px; 
            margin: 0 auto; 
        ...
        <tr>
            <td class="first-td">
                ...
                <h1>
                        ...
                        จาก '. $msg .' โปรดคำนวณราคากลางใหม่หรือตรวจสอบรายละเอียด
                        <br><br>
                </h1>
